...
async function loadAndBuild() {
  ...
  rebuildPromise = (async () => { try {
    ...
    chunks.push({
      id: 'aryan-profile-contact',
      text: `Aryan Chandra contact details and profile: Phone & WhatsApp: +91 92057 23006 (9205723006). Direct Email: aryanchandra3456@gmail.com. LinkedIn: https://www.linkedin.com/in/thearyanchandra/. GitHub: https://github.com/TheAryanchandra. Location: New Delhi, India (open to remote & relocation). Available for SDE 1 / SWE 1 / Backend / Full Stack roles with a 24-hour response SLA.`,
      metadata: { type: 'profile_contact', name: 'Aryan Chandra', phone: '+91 92057 23006', email: 'aryanchandra3456@gmail.com' },
    });
